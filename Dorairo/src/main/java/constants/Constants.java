...
public class Constants {
  ...
  public static final Perfil PERFIL_JAIRO =
      new Perfil(".", "Jairo", "jairo@ejemplo.com", ".", new Date());

  /** Perfil del usuario Doriana */
  public static final Perfil PERFIL_DORIANA =
      new Perfil("Doridc", "Doriana", "doriana@ejemplo.com", "456", new Date());
