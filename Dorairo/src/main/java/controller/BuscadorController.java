...
public class BuscadorController {
  ...
  // StackPane para organizar elementos en la cabecera relacionados con la página de inicio
  @FXML
  private StackPane stackPaneInicioCabecera;

  // StackPane para organizar elementos en la cabecera relacionados con el logotipo
  @FXML
  private StackPane stackPaneLogoCabecera;

  // StackPane para organizar elementos en la cabecera relacionados con las películas
  @FXML
  ...
  void agregarManualmenteClicked(ActionEvent event) {
    // Establecer la escena y el escenario actual
    setSceneAndStage();
    gestorVentanas.muestraVentana(stage, Constants.URL_AGREGADAS_MANUALMENTE_FXML,
        "Agregar Manualmente");
  }
  ...
  /**
   * Método para obtener los resultados de la búsqueda de series a partir de la respuesta HTTP.
   * @param response La respuesta HTTP obtenida de la API.
   * @return Una lista de objetos Series que representan los resultados de la búsqueda.
  ...
  /**
   * Método para obtener los resultados de la búsqueda de películas a partir de la respuesta HTTP.
   * @param response La respuesta HTTP obtenida de la API.
   * @return Una lista de objetos Pelicula que representan los resultados de la búsqueda.
   * @throws IOException Si ocurre un error al procesar la respuesta HTTP.
   */
  ...
  /**
   * Método para mostrar los resultados de la búsqueda de películas y series en la interfaz gráfica.
  ...
  /**
   * Asocia un evento de clic a una imagen de película para mostrar los detalles de la película.
  ...
  /**
   * Asocia un evento de clic a una imagen de serie para mostrar los detalles de la serie.
 ...
 */
  ...
  /** Método para mostrar las imagenes de las peliculas de la base de datos en el buscador
   * 
   */
  ...
  /** Método para mostrar las imagenes de las series de la base de datos en el buscador
   * 
   */
