...
public class BuscarGeneroController {
	...
	/**
	 * Maneja el evento de clic en la cabecera de inicio. Configura la escena y el
	 * escenario y muestra la ventana de inicio. Imprime un mensaje en la consola.
	 * 
	...
	/**
	 * Maneja el evento de clic en la opción de películas. Configura la escena y el
	...
	/**
	 * Maneja el evento de clic en la opción de series. Configura la escena y el
	 * escenario y muestra la ventana de series.
	 * 
	 * @param event El evento de clic del mouse.
	 */
	@FXML
	 ...
	 * escenario y muestra la ventana de buscador.
	 * 
	 * @param event El evento de clic del mouse.
	 */
	@FXML
	...
	/**
	 * Maneja el evento de clic en un ImageView de detalles. Obtiene el
	 * identificador de la película desde el ImageView y luego abre la ventana de
	 * detalles utilizando este identificador.
	 * 
	...
	/**
	 * Abre la ventana de detalles utilizando el identificador de la película
	 * proporcionado. Configura la escena y el escenario y muestra la ventana de
	 * detalles.
	 * 
	...
	/**
	 * Obtiene el identificador de la película almacenado en el userData del
	 * ImageView.
	 * 
	 * @param imageView El ImageView del que se extraerá el ID.
	 * @return El identificador de la película, o una cadena vacía si no se
	 *         encuentra.
	 */
	...
	/**
	 * Carga y muestra las imágenes de las películas asociadas a un género
	 * específico.
	 *
	...
	/**
	 * Retorna el contenedor HBox utilizado para mostrar las imágenes de las
	 * películas o series.
	 *
	 * @return El contenedor HBox que muestra las imágenes de las películas o
	 *         series.
	 */
