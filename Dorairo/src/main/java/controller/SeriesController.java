...
public class SeriesController {
	...
	/**
	 * Método manejador para el evento de clic en el botón de inicio. Cambia la
	 * escena y el escenario y muestra la ventana de inicio.
	 * 
	...
	/**
	 * Método manejador para el evento de clic en el botón de películas. Cambia la
	 * escena y el escenario y muestra la ventana de películas.
	 * 
	 * @param event El evento del ratón
	 */
	@FXML
	...
	/**
	 * Método manejador para el evento de clic en el botón de series. Cambia la
	 * escena y el escenario y muestra la ventana de series.
	 * 
	 * @param event El evento del ratón
	 */
	@FXML
	...
	/**
	 * Método manejador para el evento de clic en el botón de buscador. Cambia la
	 * escena y el escenario y muestra la ventana del buscador.
	 * 
	 * @param event El evento del ratón
	 */
	@FXML
	...
	/**
	 * Método manejador para el evento de clic en el botón de perfil. Cambia la
	 * escena y el escenario y muestra la ventana del perfil.
	 * 
	 * @param event El evento del ratón
	 */
	@FXML
	...
	/**
	 * Método manejador para el evento de clic en el botón de detalles. Cambia la
	 * escena y el escenario y muestra la ventana de detalles.
	 * 
	 * @param event El evento del ratón
	 */
	@FXML
	...
	/**
	 * Maneja el evento de clic en un ImageView para mostrar los detalles de la
	 * serie.
	 * 
	...
	/**
	 * Maneja el evento de clic en un género para mostrar las series
	 * correspondientes.
	 * 
	...
	/**
	 * Maneja el evento de clic en el botón de serie aleatoria para abrir una serie
	 * aleatoria.
	 */
	@FXML
	...
	/**
	 * Abre la ventana de la serie aleatoria si se encuentra una serie aleatoria
	 * disponible. Si no se encuentra ninguna serie aleatoria, imprime un mensaje de
	 * error.
	 */
	 ...
	 * 
	 * @return La serie aleatoria, o null si no se encuentra ninguna serie
	 *         disponible.
	 */
	...
	public void agregarImagenAMiListaSerie() {
		...
		List<UsuarioSerie> listaUsuarioSerie = usDao
				.searchSeriesMiLista(UsuarioController.getUsuarioRegistrado().getUser());
	...
	public void agregarImagenAYaVistaSerie() {
		UsuarioSerieDaoImpl usDao = new UsuarioSerieDaoImpl(session);
		List<UsuarioSerie> listaUsuarioSerie = usDao
				.searchSeriesYaVista(UsuarioController.getUsuarioRegistrado().getUser());
	...
	/**
	 * Crea un ImageView a partir de una serie y configura su tamaño y evento de
	 * clic.
	 * 
